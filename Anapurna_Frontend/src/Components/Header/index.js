...
const Header = () => {
    ...
    return (
        <div className="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 py-md-4 mb-3 bg-white border-bottom shadow-sm">
            <div className="logo-container">
                <img className="logo" src={logo} alt="logo" />
            </div>
            <h5 className="my-0 mr-md-auto font-weight-normal">HungerBuzz</h5>
