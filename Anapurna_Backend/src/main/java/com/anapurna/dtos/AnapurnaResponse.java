...
public class AnapurnaResponse {
	...
	public static ResponseEntity<AnapurnaResponse> error(String message) {
		return ResponseEntity.ok(new AnapurnaResponse(Status.ERROR, message));
	}

	public static ResponseEntity<AnapurnaResponse> error(String message, Object data) {
		return ResponseEntity.ok(new AnapurnaResponse(Status.ERROR, data, message));
	}
